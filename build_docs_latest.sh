...
VERSION="0.27.0" # LATEST PUBLISHED VERSION
...
CMD="CARGO_TARGET_DIR=\"$TMP_DIR\" RUSTFLAGS=\"-Ctarget-cpu=native --cfg nightly\" RUSTDOCFLAGS=\"-Ctarget-cpu=native --cfg nightly -Z unstable-options --generate-link-to-definition --html-in-header ./src/_doc/rustdoc-header.html\" cargo +nightly doc --no-deps -F _docs,__publish"
