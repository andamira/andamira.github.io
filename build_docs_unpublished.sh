...
VERSION="0.29.0-wip" # UNPUBLISHED VERSION
...
CMD="CARGO_TARGET_DIR=\"$TMP_DIR\" RUSTFLAGS=\"-Ctarget-cpu=native --cfg nightly\" RUSTDOCFLAGS=\"-Ctarget-cpu=native --cfg nightly -Z unstable-options --generate-link-to-definition --html-in-header ./src/_doc/header.html\" cargo +nightly doc --no-deps -F _docs,__publish"
